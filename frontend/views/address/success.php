    ...
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                ...
                <li class="line">|</li>
                <li><a href="<?=\yii\helpers\Url::to(['address/orindex'])?>">我的订单</a></li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="success w990 bc mt15">
    ...
    <div class="success_bd">
        ...
        <p class="message">你可以 <a href="<?=\yii\helpers\Url::to(['address/orindex'])?>">查看订单状态</a>  <a href="<?=\yii\helpers\Url::to(['good/index'])?>">继续购物</a> <a href="">问题反馈</a></p>
    </div>
</div>
<!-- 主体部分 end -->
