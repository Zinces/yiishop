...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <?=\yii\helpers\Html::img($model->logo)?>             <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($models as $mode):?>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><?=\yii\helpers\Html::img('http://www.yii2.cn'.($mode->path))?></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-m-d H:i',$model->create_time)?></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>


                <form action="<?=\yii\helpers\Url::to(['address/addgoods'])?>" method="post" class="choose">
                    <ul>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品编号：</span><?=$model->sn?></li>
                            <li><span>品牌：</span><?=$model->brand->intro?></li>
                            <li><span>上架时间：</span><?=date('Y-m-d H:i:s',$model->create_time)?></li>
                            <li><span>商品库存：</span><?=$model->stock?></li>
