        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot2.jpg')?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot3.jpg')?></a></dt>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="filter mt10">
            ...
            <div class="filter_wrap">
                <dl>
                   ...
                   <dd><?=\yii\helpers\Html::a($model->intro)?></dd>
                   <?php endforeach;?>
                </dl>
        ...
        <div class="goodslist mt10">
            ...
            <ul>
                ...
                <li>
                    <dl>
                        <dd><a href=""><?=\yii\helpers\Html::img($good->logo)?></a></dd>
                        <dd><?=\yii\helpers\Html::a($good->name,['address/good','id'=>$good->id])?></dd>
